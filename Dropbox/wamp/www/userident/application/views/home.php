        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {
                    ?>
                    <span class="label label-success"> You are successfully logged in!</span>
                    <?php
                    }
                    ?>  
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form class="form-signin" method="post" action="<?php echo base_url(); ?>index.php/user/submit_registration">
                        <h2 class="form-signin-heading">Please register!</h2>
                        <label class="sr-only" for="inputName">Name</label>
                        <input type="name" name="name" autofocus="" required="Please enter your name" placeholder="Your Name" class="form-control" id="inputName">
